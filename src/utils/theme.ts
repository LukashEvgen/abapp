...
export const typography: Record<string, TextStyle> = {
  h1: {
    ...
    fontWeight: tokens.typography.weight.bold as TextStyle['fontWeight'],
    color: colors.text,
  ...
  h2: {
    ...
    fontWeight: tokens.typography.weight.semibold as TextStyle['fontWeight'],
    color: colors.text,
    letterSpacing: tokens.typography.letterSpacing.wide,
  ...
  body: {
    ...
    fontWeight: tokens.typography.weight.regular as TextStyle['fontWeight'],
    color: colors.text,
    lineHeight:
