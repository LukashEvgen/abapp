...
function buildTheme(dark: boolean) {
  ...
  return {
    ...
    radius: t.radius,
    typography: {
      h1: { fontSize: 28, fontWeight: '700' as const, letterSpacing: 0.5, color: c.text.primary, fontFamily: 'Inter-Bold' },
      h2: { fontSize: 22, fontWeight: '600' as const, letterSpacing: 0.5, color: c.text.primary, fontFamily: 'Inter-SemiBold' },
      h3: { fontSize: 18, fontWeight: '600' as const, color: c.text.primary, fontFamily: 'Inter-SemiBold' },
      body: { fontSize: 14, fontWeight: '400' as const, color: c.text.primary, fontFamily: 'Inter-Regular' },
      bodyLg: { fontSize: 16, fontWeight: '400' as const, color: c.text.primary, fontFamily: 'Inter-Regular' },
      caption: { fontSize: 12, fontWeight: '400' as const, color: c.text.secondary, fontFamily: 'Inter-Regular' },
      label: { fontSize: 11, fontWeight: '600' as const, color: c.text.accent, textTransform: 'uppercase' as const, letterSpacing: 1.2, fontFamily: 'Inter-SemiBold' },
